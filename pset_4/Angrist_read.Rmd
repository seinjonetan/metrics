...
Following the paper, we focus on middle-aged men in the 1980 census born between 1930-1939
```{r}
Angrist80_YOB_3039 <- subset(Angrist, CENSUS == 80 & YOB >= 40 & YOB <= 49)
```
...
```{r}
Angrist80_YOB_3039$AGEQ <- Angrist80_YOB_3039$AGEQ - 1900
Angrist80_YOB_3039$AGEQ_SQ <- Angrist80_YOB_3039$AGEQ^2

table(Angrist80_YOB_3039$AGEQ)
# table(Angrist80_YOB_3039$AGEQ_SQ)
```

# Saving for future use

```{r}
save(Angrist80_YOB_3039, file = "Angrist80_YOB_3039.Rda")
```
